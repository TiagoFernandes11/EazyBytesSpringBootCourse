...
import com.udemy.SimpleSpringWebApplication.model.EazyClass;
import com.udemy.SimpleSpringWebApplication.model.Person;
import com.udemy.SimpleSpringWebApplication.repository.EazyClassRepository;
...
public class AdminController {
    ...
    private ModelAndView displayClasses(Model model){
    ...
    private ModelAndView addNewClass(Model model, @ModelAttribute("eazyClass") EazyClass eazyClass){
        eazyClassRepository.save(eazyClass);
        ModelAndView modelAndView = new ModelAndView("redirect:/admin/displayClasses");
        return modelAndView;
    }
